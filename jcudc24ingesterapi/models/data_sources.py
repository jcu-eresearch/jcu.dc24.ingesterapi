...
class PullDataSource(_DataSource):
    ...
    sampling_script = typed("_sampling_script", (str,unicode), "Script to run to determine when to sample")
    def __init__(self, url=None, pattern=None, recursive=False, mime_type=None, field=None, processing_script=None, sampling_script=None):
